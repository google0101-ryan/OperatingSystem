...
g++ -Wall -Wextra -pedantic -ffreestanding -ggdb -O0 -ggdb -I ./src/kernel src/kernel/drivers/pic.cpp -o build/pic.o -c -m64 -mcmodel=kernel -mno-red-zone -fno-exceptions -fno-pic -fno-pie -std=c++23
g++ -Wall -Wextra -pedantic -ffreestanding -ggdb -O0 -ggdb -I ./src/kernel src/kernel/mem/pmm.cpp -o build/pmm.o -c -m64 -mcmodel=kernel -mno-red-zone -fno-exceptions -fno-pic -fno-pie -std=c++23
